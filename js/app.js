...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product bg-info">
      <div>
    <img class="product-image" src=${image}></img>
      ...
      <p>Rating: <span class="star"><i class="fas fa-star"></span></i> ${rating}  |  Total Rate: <span class="user"><i class="fas fa-user"></i></span> ${ratingCount}</p>
      <p></p>
